...
class Classification(object):
	...
	def unigram(self, all_tweets, classes):
	...
	def bigram(self, all_tweets, classes):
		matrix = self.m.create_matrix(all_tweets)
	...
	def unigram_e_bigram(self, all_tweets, classes):
		matrix = self.m.create_matrix(all_tweets)
...
def main():
	...
	classifier.unigram(tweets_unigram, classes)
	#classifier.bigram(tweets_bigram, classes)
	#classifier.unigram_e_bigram(tweets_unigram_bigram, classes)
