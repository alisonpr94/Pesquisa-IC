...
class Classification(object):
    ...
    def ensemble(self, all_tweets, matriz_pos, classes):
        matrix1 = self.m.create_matrix(all_tweets)

        matrix = np.concatenate((matrix1.toarray(), matriz_pos), axis=1)
...
def main():
    ...
    classifier.ensemble(tweets_unigram_bigram, matriz_pos, classes)
