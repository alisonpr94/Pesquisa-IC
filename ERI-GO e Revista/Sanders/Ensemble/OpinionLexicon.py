...
class Resultados(object):
    ...
    def unigram_e_bigram(self, tweets, lex, classes):
        matrix1 = self.m.create_matrix_pres(tweets)
...
def main():
    ...
    matriz_lex = criaLex.opinion_lexicon(lex_positivo, lex_negativo, all_tweets)
    ...
    result.unigram_e_bigram(unigram_and_bigram, matriz_lex, classes)
