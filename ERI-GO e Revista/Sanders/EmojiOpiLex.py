...
class Resultados(object):
    ...
    def result_unigram(self, tweets_unigram, matriz, classes):
    ...
    def result_bigram(self, tweets_bigram, matriz, classes):
        matrix = self.m.create_matrix(tweets_bigram)
        
        matrix = np.concatenate((matrix.toarray(), matriz), axis=1)
    ...
    def result_unigram_e_bigram(self, tweets_unigram, tweets_bigram, matriz, classes):
        matrix1 = self.m.create_matrix(tweets_unigram)
        matrix2 = self.m.create_matrix(tweets_bigram)
        
        matrix = np.concatenate((matrix1.toarray(), matrix2.toarray()), axis=1)
        matrix = np.concatenate((matrix, matriz), axis=1)
...
def main():
    ...
    matrix = np.concatenate((matriz_lex, matriz_emoji), axis=1)
    ...
    #result.result_unigram(tweets_unigram, matrix, classes)
    #result.result_bigram(tweets_bigram, matrix, classes)
    result.result_unigram_e_bigram(tweets_unigram, tweets_bigram, matrix, classes)
