...
class Resultados(object):
    ...
    def result_unigram(self, tweets_unigram, emoji, classes):
        matrix = self.m.create_matrix(tweets_unigram)

        matrix = np.concatenate((matrix.toarray(), emoji), axis=1)
    ...
    def result_bigram(self, tweets_bigram, emoji, classes):
    ...
    def result_unigram_e_bigram(self, tweets, emoji, classes):
...
def main():
    ...
    result.result_unigram_e_bigram(unigram_and_bigram, matriz_emoji, classes)
