...
class Resultados(object):
    ...
    def result_unigram(self, tweets_unigram, classes):
    ...
    def result_bigram(self, tweets_bigram, classes):
...
def main():
    ...
    #result.result_unigram(tweets_unigram, classes)
    #result.result_bigram(tweets_bigram, classes)
